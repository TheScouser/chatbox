...
function DashboardOverview() {
  ...
  // Loading state
  const isLoading = agents === undefined || conversations === undefined || 
                   knowledgeEntries === undefined || messages === undefined
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h3 className={`text-sm font-medium ${
                  ...
                  {agentCount > 0 ? 'Agent created!' : 'Create your first agent'}
                </h3>
