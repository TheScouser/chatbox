...
function VectorSearchDemo() {
	...
	const handleTextSearch = async () => {
		...
		try {
			...
			alert(
				"Text search not implemented in this demo. Use Vector Search instead!",
			);
			setSearchResults([]);
		} catch (error) {
			alert(`Error: ${error}`);
		...
		<div className="container mx-auto p-6 space-y-6">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>Choose an agent to work with</CardDescription>
				</CardHeader>
			...
			<Card>
				...
				<CardContent className="space-y-4">
					<div className="flex gap-2">
						...
						<Button onClick={handleGenerateAllEmbeddings} variant="outline">
