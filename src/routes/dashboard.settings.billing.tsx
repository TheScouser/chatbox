...
import { CreditCard, ExternalLink, Download, Calendar } from "lucide-react"
                ...
                <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600">{plan ? formatPrice(plan.price) : "Free"}</p>
                        </div>
                    ...
                    {isFree ? (
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="text-center py-8 text-gray-500">
                                ...
                                <p className="text-sm">Your invoices and payment history will be displayed once available</p>
                            </div>
                    ...
                    {isFree ? (
                        ...
                        <div className="space-y-4">
                            <div className="text-center py-6 text-gray-500">
                                ...
                                <p className="text-sm">Use the "Manage Billing" button above to update your payment method</p>
                            </div>
                        </div>
                    )}
                </CardContent>
