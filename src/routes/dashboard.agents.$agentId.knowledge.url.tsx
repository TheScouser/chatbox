		...
		<div className="space-y-6">
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
				...
				<div className="p-6">
					...
					<p className="mt-1 text-sm text-gray-500">
						Enter a webpage URL to automatically extract and add its content to
						your knowledge base.
					</p>
				</div>
				<form
						...
						<div className="flex items-start">
							...
							<div>
								...
								<p className="text-sm text-blue-700 mt-1">
									...
									content to your knowledge base. The system will fetch the page
									content, extract the text, and make it searchable for your AI
									agent.
								</p>
							</div>
						</div>
