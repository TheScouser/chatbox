    ...
    <div className="container mx-auto p-6 space-y-6">
                ...
                <div className="grid gap-2">
                  {conversations.slice(0, 5).map((conversation) => (
                    <Button
                      ...
                      variant={currentConversationId === conversation._id ? "default" : "outline"}
          ...
          <div className="space-y-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <div className="text-sm">
                  <strong>Conversation:</strong> {currentConversationId || 'None'}
                </div>
                <div className="text-sm">
                  <strong>Total Conversations:</strong> {conversations?.length || 0}
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      {!selectedAgentId && (
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground">
            Choose an agent from the list above to begin testing the chat interface
          </p>
        </div>
      )}
    </div>
