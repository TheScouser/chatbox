        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              This is a demo page showing how the chat bubble widget appears on your website. 
              The floating chat bubble in the bottom-right corner is your agent!
            </p>
          </header>
          ...
          <div className="text-center bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-6">
              ...
              with the AI agent. This is exactly how your website visitors will interact with it.
            </p>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-800">
                <strong>💡 Tip:</strong> The chat widget is fully functional! It will use your agent's knowledge base 
                to answer questions. Try asking about topics related to your uploaded documents or knowledge entries.
              </p>
            </div>
