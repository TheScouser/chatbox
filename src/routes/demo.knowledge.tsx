      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white rounded-lg shadow p-6">
            <h1 className="text-2xl font-bold text-gray-900 mb-6">Knowledge Base Demo</h1>
            ...
            {!firstAgent ? (
              ...
              <div>
                <p className="text-gray-600 mb-4">
                  Testing knowledge base functionality with agent: <strong>{firstAgent.name}</strong>
                </p>
                <a 
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              <h2 className="text-lg font-medium text-gray-900 mb-4">Phase 4 Completed Features</h2>
