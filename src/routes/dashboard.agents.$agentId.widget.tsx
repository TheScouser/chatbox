...
function WidgetDesigner() {
	...
	const [activeTab, setActiveTab] = useState<
		"branding" | "interface" | "texts" | "configure"
	>("branding");
	const [selectedWidgetId, setSelectedWidgetId] =
		useState<Id<"widgetConfigurations"> | null>(null);
			...
			<div className="w-[420px] border-r border-border flex flex-col bg-background">
				...
				<div className="px-6 py-4 border-b border-border flex items-center gap-3">
					...
					<div className="flex-1 min-w-0">
						<Select
							...
							onValueChange={(value) =>
								setSelectedWidgetId(value as Id<"widgetConfigurations">)
							}
						>
				...
				>
					<TabsList className="w-full rounded-none border-b border-border bg-transparent px-6 h-12">
						<TabsTrigger
							value="branding"
							className="flex-1 gap-1.5 data-[state=active]:bg-transparent"
						>
				...
				<div className="w-full max-w-lg">
					<div className="text-center mb-6">
						...
						<p className="text-sm text-muted-foreground">
							See how your widget will look to users
						</p>
					</div>
