					...
					{features.map((feature, index) => {
						...
						return (
							<div
								key={feature.title}
								className={
									"group p-8 rounded-2xl border border-border bg-card hover:border-primary/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-scale-in"
								}
