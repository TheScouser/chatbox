...
export function UsageProgress({ metric, title, description }: UsageProgressProps) {
    const { usage, limit, percentUsed, loading, canPerformAction } = useUsageLimit(metric);
    ...
    const getStatusBadge = (percent: number) => {
        if (percent >= 100) return <Badge variant="destructive">Limit Reached</Badge>;
