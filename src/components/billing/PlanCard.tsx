...
export function PlanCard({
	...
	const coreFeatures = [
		{ label: "Agents", value: formatNumber(features.maxAgents) },
		{
			...
			value: formatNumber(features.maxKnowledgeEntries),
		},
		{
			label: "Messages/Month",
			value: formatNumber(features.maxMessagesPerMonth),
		},
	...
	const premiumFeatures = [
		...
		{ key: "apiAccess", label: "API Access", enabled: features.apiAccess },
		{
			...
			enabled: features.webhookIntegrations,
		},
		{
			key: "customBranding",
		...
		},
		{
			...
			enabled: features.ssoIntegration,
		},
