...
export function AgentUsageChart({ agents, totalCredits, loading = false }: AgentUsageChartProps) {
    if (loading) {
        return (
            <Card>
                <CardHeader>
            ...
            return (
                <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-3">
                    ...
                    <p className="text-blue-600">
                        <span className="font-medium">{data.creditsUsed}</span> credits ({data.percentage.toFixed(1)}%)
                    </p>
                ...
                {payload.map((entry: any, index: number) => (
                    <div key={index} className="flex items-center justify-between text-sm">
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <span className="font-medium truncate max-w-32">{entry.payload.agentName}</span>
                        </div>
                ...
                {agents.length === 0 ? (
                    <div className="flex items-center justify-center h-64 text-gray-500">
                        <div className="text-center">
                            ...
                            <p className="text-sm">Agent usage will appear here once they start being used</p>
                        </div>
                    </div>
                ) : (
                    <div className="space-y-4">
                        ...
                        <div className="border-t pt-4">
                            <h4 className="font-medium text-sm mb-3 text-gray-700">Agent Breakdown</h4>
