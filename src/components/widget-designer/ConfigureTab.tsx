...
export function ConfigureTab({ config, onChange }: ConfigureTabProps) {
	const customBrandingAccess = useFeatureAccess("customBranding");
	const downloadTranscriptsAccess = useFeatureAccess("downloadTranscripts");
			...
			<FormSection title="General">
				<div className="space-y-3">
					...
					<ToggleRow
						...
						disabled={!downloadTranscriptsAccess.hasAccess}
						upgradePrompt={!downloadTranscriptsAccess.hasAccess ? "Upgrade plan to use this option" : undefined}
					/>
				</div>
			</FormSection>
