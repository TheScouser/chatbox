            ...
            <FormSection title="General">
                <div className="space-y-3">
                    <ToggleRow
                        ...
                        upgradePrompt={
                            !customBrandingAccess.hasAccess
                                ? "Upgrade plan to use this option"
                                : undefined
                        }
                    />
                    <ToggleRow
                    ...
                    {config.config.voiceInputEnabled && (
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    onChange({
                                        config: {
                                            ...config.config,
                                            voiceMaxDuration: Number.parseInt(e.target.value) || 60,
                                        },
                                    })
                                }
                                min={5}
                            ...
                            <p className="text-xs text-muted-foreground">
                                The maximum duration of a voice recording. Leave blank for
                                default (60 seconds).
                            </p>
                        </div>
                    )}
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    onChange({
                                        config: {
                                            ...config.config,
                                            autoOpenDelay: Number.parseInt(e.target.value) || 3,
                                        },
                                    })
                                }
                                min={0}
